...
def _handle_order_arg(order, backend):
    ...
    if isinstance(order, iap.StochasticParameter):
        return order
    raise Exception(
        "Expected order to be imgaugv1.ALL, int, list of int or "
...
def _handle_mode_arg(mode):
    ...
    if isinstance(mode, iap.StochasticParameter):
        return mode
    raise Exception(
        "Expected mode to be imgaugv1.ALL, a string, a list of strings "
...
def generate_jigsaw_destinations(nb_rows, nb_cols, max_steps, seed,
    ...
    seed : None or int or imgaugv1.random.RNG or numpy.random.Generator or numpy.random.BitGenerator or numpy.random.SeedSequence or numpy.random.RandomState
...
class Affine(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    scale : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter or dict {"x": number/tuple/list/StochasticParameter, "y": number/tuple/list/StochasticParameter}, optional
    ...
    translate_percent : None or number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter or dict {"x": number/tuple/list/StochasticParameter, "y": number/tuple/list/StochasticParameter}, optional
    ...
    translate_px : None or int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter or dict {"x": int/tuple/list/StochasticParameter, "y": int/tuple/list/StochasticParameter}, optional
    ...
    rotate : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
    ...
    shear : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter or dict {"x": int/tuple/list/StochasticParameter, "y": int/tuple/list/StochasticParameter}, optional
    ...
    order : int or iterable of int or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter, optional
        ...
        As datatypes this parameter accepts:
            ...
            * If a list, then a random value will be sampled from that list
              per image.
            * If ``imgaugv1.ALL``, then equivalant to list ``[0, 1, 3, 4, 5]``
    ...
    cval : number or tuple of number or list of number or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter, optional
        ...
        ``uint8`` images. It may be a float value.
            ...
            * If a list, then a random value will be sampled from that list
              per image.
            * If ``imgaugv1.ALL`` then equivalent to tuple ``(0, 255)`.
            * If a ``StochasticParameter``, a new value will be sampled from
              the parameter per image.

    mode : str or list of str or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter, optional
        ...
        The datatype of the parameter may be:
            ...
            * If ``imgaugv1.ALL``, then a random mode from all possible modes
              will be picked.
    ...
    fit_output : bool, optional
        ...
        :class:`~imgaugv1.augmenters.size.KeepSizeByResize`,
...
class ScaleX(Affine):
    ...
    **Supported dtypes**:
    ...
    See :class:`~imgaugv1.augmenters.geometric.Affine`.

    Parameters
    ----------
    scale : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
...
class TranslateX(Affine):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    percent : None or number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
    ...
    px : None or int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter or dict {"x": int/tuple/list/StochasticParameter, "y": int/tuple/list/StochasticParameter}, optional
...
class ShearX(Affine):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    shear : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
...
class AffineCv2(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    translate_percent : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter or dict {"x": number/tuple/list/StochasticParameter, "y": number/tuple/list/StochasticParameter}, optional
        Translation as a fraction of the image height/width (x-translation,
        y-translation), where ``0`` denotes "no change" and ``0.5`` denotes
        "half of the axis size".
    ...
    translate_px : int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter or dict {"x": int/tuple/list/StochasticParameter, "y": int/tuple/list/StochasticParameter}, optional
        Translation in pixels.
    ...
    order : int or list of int or str or list of str or imaug.ALL or imgaugv1.parameters.StochasticParameter, optional
        ...
        ``INTER_NEAREST`` (linear interpolation) are the fastest.
            ...
            * If an iterable of ``int``/``str``, then for each image a random
              ...
              order values).
            * If ``imgaugv1.ALL``, then equivalant to list ``[cv2.INTER_NEAREST,
              cv2.INTER_LINEAR, cv2.INTER_CUBIC, cv2.INTER_LANCZOS4]``.
            * If ``StochasticParameter``, then that parameter is queried per
              image to sample the order value to use.

    cval : number or tuple of number or list of number or imaug.ALL or imgaugv1.parameters.StochasticParameter, optional
        The constant value to use when filling in newly created pixels.
        (E.g. translating by 1px to the right will create a new 1px-wide
        column of pixels on the left of the image).  The value is only used
        when `mode=constant`. The expected value range is ``[0, 255]`` for
    ...
    mode : int or str or list of str or list of int or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter,
           optional
        Method to use when filling in newly created pixels.
    ...
    def __init__(self, scale=1.0, translate_percent=None, translate_px=None,
        ...
        ia.warn_deprecated(
            ...
            "Use imgaugv1.augmenters.geometric.Affine(..., backend='cv2') "
        ...
        if order == ia.ALL:
            ...
            raise Exception(
                "Expected order to be imgaugv1.ALL, int, string, a list of"
        ...
        if mode == ia.ALL:
            ...
            raise Exception(
                "Expected mode to be imgaugv1.ALL, an int, a string, a list of "
...
class PiecewiseAffine(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    scale : float or tuple of float or imgaugv1.parameters.StochasticParameter, optional
    ...
    nb_rows : int or tuple of int or imgaugv1.parameters.StochasticParameter, optional
    ...
    nb_cols : int or tuple of int or imgaugv1.parameters.StochasticParameter, optional
        Number of columns. Analogous to `nb_rows`.

    order : int or list of int or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter, optional
        See :func:`~imgaugv1.augmenters.geometric.Affine.__init__`.

    cval : int or float or tuple of float or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter, optional
        See :func:`~imgaugv1.augmenters.geometric.Affine.__init__`.
    ...
    polygon_recoverer : 'auto' or None or imgaugv1.augmentables.polygons._ConcavePolygonRecoverer, optional
        The class to use to repair invalid polygons.
        If ``"auto"``, a new instance of
        :class`imgaugv1.augmentables.polygons._ConcavePolygonRecoverer`
        will be created.
...
class PerspectiveTransform(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    if (keep_size=True):
        ...
        minimum of (
            ``imgaugv1.augmenters.geometric.PerspectiveTransform(keep_size=False)``,
            :func:`~imgaugv1.imgaugv1.imresize_many_images`
        )
    ...
    mode : int or str or list of str or list of int or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter, optional
    ...
    def _handle_mode_arg(cls, mode):
        ...
        if isinstance(mode, iap.StochasticParameter):
            return mode
        raise Exception(
            "Expected mode to be imgaugv1.ALL, an int, a string, a list "
...
class ElasticTransformation(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    alpha : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
    ...
    sigma : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
    ...
    order : int or list of int or imaug.ALL or imgaugv1.parameters.StochasticParameter, optional
        ...
        in the range ``0`` to ``5``, where orders close to ``0`` are faster.
            ...
            * If a list, then for each image a random value will be sampled
              from that list.
            * If ``imgaugv1.ALL``, then equivalant to list
              ``[0, 1, 2, 3, 4, 5]``.
            * If ``StochasticParameter``, then that parameter is queried per
              image to sample the order value to use.
    ...
    cval : number or tuple of number or list of number or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter, optional
        ...
        be a ``float`` value, even for images with integer dtypes.
            ...
            * If a list, then a random value will be picked from that list per
              image.
            * If ``imgaugv1.ALL``, a value from the discrete range ``[0..255]``
...
class Rot90(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    if (keep_size=True):
        ...
        minimum of (
            ``imgaugv1.augmenters.geometric.Rot90(keep_size=False)``,
            :func:`~imgaugv1.imgaugv1.imresize_many_images`
        )

    Parameters
    ----------
    k : int or list of int or tuple of int or imaug.ALL or imgaugv1.parameters.StochasticParameter, optional
        How often to rotate clockwise by 90 degrees.
            ...
            * If a list, then for each image a random value will be sampled
              from that list.
            * If ``imgaugv1.ALL``, then equivalant to list ``[0, 1, 2, 3]``.
            * If ``StochasticParameter``, then that parameter is queried per
...
class Jigsaw(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.augmenters.geometric.apply_jigsaw`.

    Parameters
    ----------
    nb_rows : int or list of int or tuple of int or imgaugv1.parameters.StochasticParameter, optional
    ...
    nb_cols : int or list of int or tuple of int or imgaugv1.parameters.StochasticParameter, optional
    ...
    max_steps : int or list of int or tuple of int or imgaugv1.parameters.StochasticParameter, optional
