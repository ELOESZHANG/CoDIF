...
# TODO this is the same as in imgaugv1.py, make DRY
# Added in 0.4.0.
...
def pad(arr, top=0, right=0, bottom=0, left=0, mode="constant", cval=0):
    ...
    Added in 0.4.0. (Previously named ``imgaugv1.imgaugv1.pad()``.)
...
def pad_to_aspect_ratio(arr, aspect_ratio, mode="constant", cval=0,
    ...
    See :func:`~imgaugv1.imgaugv1.compute_paddings_for_aspect_ratio` for an
    explanation of how the required padding amounts are distributed per
    image axis.

    Added in 0.4.0. (Previously named ``imgaugv1.imgaugv1.pad_to_aspect_ratio()``.)

    **Supported dtypes**:

    See :func:`~imgaugv1.augmenters.size.pad`.
    ...
    mode : str, optional
        Padding mode to use. See :func:`~imgaugv1.imgaugv1.pad` for details.
...
def pad_to_multiples_of(arr, height_multiple, width_multiple, mode="constant",
    ...
    Added in 0.4.0. (Previously named ``imgaugv1.imgaugv1.pad_to_multiples_of()``.)
...
def compute_paddings_to_reach_aspect_ratio(arr, aspect_ratio):
    ...
    ``imgaugv1.imgaugv1.compute_paddings_to_reach_aspect_ratio()``.)
...
def compute_paddings_to_reach_multiples_of(arr, height_multiple,
    ...
    Added in 0.4.0. (Previously named
    ``imgaugv1.imgaugv1.compute_paddings_to_reach_multiples_of()``.)
...
def compute_paddings_to_reach_powers_of(arr, height_base, width_base,
    ...
    Added in 0.4.0. (Previously named
    ``imgaugv1.imgaugv1.compute_paddings_to_reach_exponents_of()``.)
...
class Resize(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.imgaugv1.imresize_many_images`.

    Parameters
    ----------
    size : 'keep' or int or float or tuple of int or tuple of float or list of int or list of float or imgaugv1.parameters.StochasticParameter or dict
    ...
    interpolation : imgaugv1.ALL or int or str or list of int or list of str or imgaugv1.parameters.StochasticParameter, optional
        Interpolation to use.

            * If ``imgaugv1.ALL``, then a random interpolation from ``nearest``,
...
class CropAndPad(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    if (keep_size=True):
        ...
        minimum of (
            ``imgaugv1.augmenters.size.CropAndPad(keep_size=False)``,
            :func:`~imgaugv1.imgaugv1.imresize_many_images`
        )

    Parameters
    ----------
    px : None or int or imgaugv1.parameters.StochasticParameter or tuple, optional
    ...
    percent : None or number or imgaugv1.parameters.StochasticParameter or tuple, optional
        The number of pixels to crop (negative values) or pad (positive values)
    ...
    pad_mode : imgaugv1.ALL or str or list of str or imgaugv1.parameters.StochasticParameter, optional
        ...
        by ``pad_cval`` when necessary. See :func:`~imgaugv1.imgaugv1.pad` for
        more details.

            * If ``imgaugv1.ALL``, then a random mode from all available modes
    ...
    pad_cval : number or tuple of number list of number or imgaugv1.parameters.StochasticParameter, optional
        The constant value to use if the pad mode is ``constant`` or the end
        value to use if the mode is ``linear_ramp``.
        See :func:`~imgaugv1.imgaugv1.pad` for more details.
...
class Pad(CropAndPad):
    ...
    **Supported dtypes**:
    ...
    See :class:`~imgaugv1.augmenters.size.CropAndPad`.
    ...
    percent : None or int or float or imgaugv1.parameters.StochasticParameter or tuple, optional
...
class PadToFixedSize(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    pad_mode : imgaugv1.ALL or str or list of str or imgaugv1.parameters.StochasticParameter, optional
        See :func:`~imgaugv1.augmenters.size.CropAndPad.__init__`.

    pad_cval : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
        See :func:`~imgaugv1.augmenters.size.CropAndPad.__init__`.
...
class CenterPadToFixedSize(PadToFixedSize):
    ...
    This is an alias for :class:`~imgaugv1.augmenters.size.PadToFixedSize`
    with ``position="center"``. It spreads the pad amounts equally over
    all image sides, while :class:`~imgaugv1.augmenters.size.PadToFixedSize`
    ...
    **Supported dtypes**:
    ...
    See :class:`~imgaugv1.augmenters.size.PadToFixedSize`.
...
# TODO this is very similar to CropAndPad, maybe add a way to generate crop
#      values imagewise via a callback in in CropAndPad?
# TODO add crop() function in imgaugv1, similar to pad
...
class CenterCropToFixedSize(CropToFixedSize):
    ...
    This is an alias for :class:`~imgaugv1.augmenters.size.CropToFixedSize` with
    ``position="center"``.
    ...
    **Supported dtypes**:
    ...
    See :class:`~imgaugv1.augmenters.size.CropToFixedSize`.
...
class CenterCropToMultiplesOf(CropToMultiplesOf):
    ...
    This is the same as :class:`~imgaugv1.augmenters.size.CropToMultiplesOf`,
    but uses ``position="center"`` by default, which spreads the crop amounts
    equally over all image sides, while
    :class:`~imgaugv1.augmenters.size.CropToMultiplesOf` by default spreads
    them randomly.
...
class PadToMultiplesOf(PadToFixedSize):
    ...
    **Supported dtypes**:
    ...
    pad_mode : imgaugv1.ALL or str or list of str or imgaugv1.parameters.StochasticParameter, optional
        See :func:`~imgaugv1.augmenters.size.PadToFixedSize.__init__`.
...
class CenterPadToMultiplesOf(PadToMultiplesOf):
    ...
    This is the same as :class:`~imgaugv1.augmenters.size.PadToMultiplesOf`, but
    uses ``position="center"`` by default, which spreads the pad amounts
    equally over all image sides, while
    :class:`~imgaugv1.augmenters.size.PadToMultiplesOf` by default spreads them
    randomly.
    ...
    **Supported dtypes**:
    ...
    pad_mode : imgaugv1.ALL or str or list of str or imgaugv1.parameters.StochasticParameter, optional
        See :func:`~imgaugv1.augmenters.size.PadToMultiplesOf.__init__`.
...
class CenterCropToPowersOf(CropToPowersOf):
    ...
    This is the same as :class:`~imgaugv1.augmenters.size.CropToPowersOf`, but
    uses ``position="center"`` by default, which spreads the crop amounts
    equally over all image sides, while
    :class:`~imgaugv1.augmenters.size.CropToPowersOf` by default spreads them
    randomly.
...
class CenterPadToPowersOf(PadToPowersOf):
    ...
    This is the same as :class:`~imgaugv1.augmenters.size.PadToPowersOf`, but uses
    ``position="center"`` by default, which spreads the pad amounts equally
    over all image sides, while :class:`~imgaugv1.augmenters.size.PadToPowersOf`
    ...
    **Supported dtypes**:
    ...
    pad_mode : imgaugv1.ALL or str or list of str or imgaugv1.parameters.StochasticParameter, optional
        See :func:`~imgaugv1.augmenters.size.PadToPowersOf.__init__`.
...
class CenterCropToAspectRatio(CropToAspectRatio):
    ...
    This is the same as :class:`~imgaugv1.augmenters.size.CropToAspectRatio`, but
    uses ``position="center"`` by default, which spreads the crop amounts
    equally over all image sides, while
    :class:`~imgaugv1.augmenters.size.CropToAspectRatio` by default spreads
    them randomly.
...
class CenterPadToAspectRatio(PadToAspectRatio):
    ...
    This is the same as :class:`~imgaugv1.augmenters.size.PadToAspectRatio`, but
    uses ``position="center"`` by default, which spreads the pad amounts
    equally over all image sides, while
    :class:`~imgaugv1.augmenters.size.PadToAspectRatio` by default spreads them
    randomly.
    ...
    **Supported dtypes**:
    ...
    pad_mode : imgaugv1.ALL or str or list of str or imgaugv1.parameters.StochasticParameter, optional
        See :func:`~imgaugv1.augmenters.size.PadToAspectRatio.__init__`.
...
class CropToSquare(CropToAspectRatio):
    ...
    This is identical to :class:`~imgaugv1.augmenters.size.CropToAspectRatio`
...
class CenterCropToSquare(CropToSquare):
    ...
    In contrast to :class:`~imgaugv1.augmenters.size.CropToSquare`, this
    augmenter always tries to spread the columns/rows to remove equally over
    both sides of the respective axis to be cropped.
    :class:`~imgaugv1.augmenters.size.CropToAspectRatio` by default spreads the
    croppings randomly.

    This augmenter is identical to :class:`~imgaugv1.augmenters.size.CropToSquare`
    with ``position="center"``, and thereby the same as
    :class:`~imgaugv1.augmenters.size.CropToAspectRatio` with
...
class PadToSquare(PadToAspectRatio):
    ...
    :class:`~imgaugv1.augmenters.size.PadToAspectRatio` with ``aspect_ratio=1.0``.
...
class CenterPadToSquare(PadToSquare):
    ...
    This is the same as :class:`~imgaugv1.augmenters.size.PadToSquare`, but uses
    ``position="center"`` by default, which spreads the pad amounts equally
    over all image sides, while :class:`~imgaugv1.augmenters.size.PadToSquare`
    by default spreads them randomly. This augmenter is thus also identical to
    :class:`~imgaugv1.augmenters.size.PadToAspectRatio` with
    ``aspect_ratio=1.0, position="center"``.
...
class KeepSizeByResize(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    children : Augmenter or list of imgaugv1.augmenters.meta.Augmenter or None, optional
    ...
    interpolation : KeepSizeByResize.NO_RESIZE or {'nearest', 'linear', 'area', 'cubic'} or {cv2.INTER_NEAREST, cv2.INTER_LINEAR, cv2.INTER_AREA, cv2.INTER_CUBIC} or list of str or list of int or StochasticParameter, optional
        ...
        Can take any value that :func:`~imgaugv1.imgaugv1.imresize_single_image`
        accepts, e.g. ``cubic``.
