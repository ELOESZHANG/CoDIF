...
class GammaContrast(_ContrastFuncWrapper):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.augmenters.contrast.adjust_contrast_gamma`.

    Parameters
    ----------
    gamma : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
        Exponent for the contrast adjustment. Higher values darken the image.
...
class SigmoidContrast(_ContrastFuncWrapper):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.augmenters.contrast.adjust_contrast_sigmoid`.

    Parameters
    ----------
    gain : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
        Multiplier for the sigmoid function's output.
        Higher values lead to quicker changes from dark to light pixels.
    ...
    cutoff : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
        Cutoff that shifts the sigmoid function in horizontal direction.
        Higher values mean that the switch from dark to light pixels happens
        later, i.e. the pixels will remain darker.
...
class LogContrast(_ContrastFuncWrapper):
    ...
    ``imgaugv1.augmenters.arithmetic.Multiply``.

    **Supported dtypes**:

    See :func:`~imgaugv1.augmenters.contrast.adjust_contrast_log`.
...
class LinearContrast(_ContrastFuncWrapper):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.augmenters.contrast.adjust_contrast_linear`.
...
class AllChannelsCLAHE(meta.Augmenter):
    ...
    In contrast to ``imgaugv1.augmenters.contrast.CLAHE``, this augmenter
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    clip_limit : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
        See ``imgaugv1.augmenters.contrast.CLAHE``.

    tile_grid_size_px : int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter or tuple of tuple of int or tuple of list of int or tuple of imgaugv1.parameters.StochasticParameter, optional
        See ``imgaugv1.augmenters.contrast.CLAHE``.
...
class CLAHE(meta.Augmenter):
    ...
    ``imgaugv1.augmenters.contrast.AllChannelsCLAHE`` instead.
    ...
    **Supported dtypes**:
        ...
        * ``bool``: no (1)
        ...
        - (1) This augmenter uses
              :class:`~imgaugv1.augmenters.color.ChangeColorspace`, which is
    ...
    from_colorspace : {"RGB", "BGR", "HSV", "HLS", "Lab"}, optional
        ...
        See also :func:`~imgaugv1.augmenters.color.change_colorspace_` for
        details.
    ...
    to_colorspace : {"Lab", "HLS", "HSV"}, optional
        ...
        see ``imgaugv1.augmenters.contrast.AllChannelsCLAHE``.
...
class AllChannelsHistogramEqualization(meta.Augmenter):
    ...
    In contrast to ``imgaugv1.augmenters.contrast.HistogramEqualization``, this
...
class HistogramEqualization(meta.Augmenter):
    ...
    This augmenter is similar to ``imgaugv1.augmenters.contrast.CLAHE``.
    ...
    ``imgaugv1.augmenters.contrast.AllChannelsHistogramEqualization`` instead.
    ...
    **Supported dtypes**:
    ...
    to_colorspace : {"Lab", "HLS", "HSV"}, optional
        ...
        ``imgaugv1.augmenters.contrast.AllChannelsHistogramEqualization``.
