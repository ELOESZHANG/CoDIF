...
class RandAugment(meta.Sequential):
    ...
    **Supported dtypes**:
    ...
    minimum of (
        :class:`~imgaugv1.augmenters.flip.Fliplr`,
        :class:`~imgaugv1.augmenters.size.KeepSizeByResize`,
        :class:`~imgaugv1.augmenters.size.Crop`,
        :class:`~imgaugv1.augmenters.meta.Sequential`,
        :class:`~imgaugv1.augmenters.meta.SomeOf`,
        :class:`~imgaugv1.augmenters.meta.Identity`,
        :class:`~imgaugv1.augmenters.pillike.Autocontrast`,
        :class:`~imgaugv1.augmenters.pillike.Equalize`,
        :class:`~imgaugv1.augmenters.arithmetic.Invert`,
        :class:`~imgaugv1.augmenters.pillike.Affine`,
        :class:`~imgaugv1.augmenters.pillike.Posterize`,
        :class:`~imgaugv1.augmenters.pillike.Solarize`,
        :class:`~imgaugv1.augmenters.pillike.EnhanceColor`,
        :class:`~imgaugv1.augmenters.pillike.EnhanceContrast`,
        :class:`~imgaugv1.augmenters.pillike.EnhanceBrightness`,
        :class:`~imgaugv1.augmenters.pillike.EnhanceSharpness`,
        :class:`~imgaugv1.augmenters.arithmetic.Cutout`,
        :class:`~imgaugv1.augmenters.pillike.FilterBlur`,
        :class:`~imgaugv1.augmenters.pillike.FilterSmooth`
    )
    ...
    n : int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter or None, optional
        ...
        See also parameter ``n`` in :class:`~imgaugv1.augmenters.meta.SomeOf`
        for more details.
    ...
    m : int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter or None, optional
    ...
    cval : number or tuple of number or list of number or imgaugv1.ALL or imgaugv1.parameters.StochasticParameter, optional
        ...
        :class:`~imgaugv1.augmenters.pillike.Affine` for details.
