...
def convert_cbaois_to_kpsois(cbaois):
    ...
    Parameters
    ----------
    cbaois : list of imgaugv1.augmentables.bbs.BoundingBoxesOnImage or list of imgaugv1.augmentables.bbs.PolygonsOnImage or list of imgaugv1.augmentables.bbs.LineStringsOnImage or imgaugv1.augmentables.bbs.BoundingBoxesOnImage or imgaugv1.augmentables.bbs.PolygonsOnImage or imgaugv1.augmentables.bbs.LineStringsOnImage
        Coordinate-based augmentables to convert, e.g. bounding boxes.

    Returns
    -------
    list of imgaugv1.augmentables.kps.KeypointsOnImage or imgaugv1.augmentables.kps.KeypointsOnImage
...
def invert_convert_cbaois_to_kpsois_(cbaois, kpsois):
    ...
    kpsois : list of imgaugv1.augmentables.kps.KeypointsOnImages or imgaugv1.augmentables.kps.KeypointsOnImages
