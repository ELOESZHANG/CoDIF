"""Functions dealing with normalization of user input data to imgaugv1 classes."""
...
def _assert_exactly_n_shapes(shapes, n, from_ntype, to_ntype):
    ...
    if len(shapes) != n:
        raise ValueError(
            ...
            "is recommended to provide imgaugv1 standard classes, e.g. "
...
def normalize_line_strings(inputs, shapes=None):
    # TODO get rid of this deferred import
    from ..augmentables.lines import LineString, LineStringsOnImage
...
def _invert_normalize_polygons_and_line_strings(inputs, inputs_old,
                                                ...
                                                get_points_func):
    # TODO get rid of this deferred import
    from ..augmentables.kps import Keypoint
