...
class UnnormalizedBatch(object):
    ...
    heatmaps : None or (N,H,W,C) ndarray or imgaugv1.augmentables.heatmaps.HeatmapsOnImage or iterable of (H,W,C) ndarray or iterable of imgaugv1.augmentables.heatmaps.HeatmapsOnImage
    ...
    segmentation_maps : None or (N,H,W) ndarray or imgaugv1.augmentables.segmaps.SegmentationMapsOnImage or iterable of (H,W) ndarray or iterable of imgaugv1.augmentables.segmaps.SegmentationMapsOnImage
    ...
    def to_normalized_batch(self):
        ...
        Returns
        -------
        imgaugv1.augmentables.batches.Batch
    ...
    def fill_from_augmented_normalized_batch_(self, batch_aug_norm):
        ...
        Parameters
        ----------
        batch_aug_norm: imgaugv1.augmentables.batches.Batch
            Batch after normalization and augmentation.

        Returns
        -------
        imgaugv1.augmentables.batches.UnnormalizedBatch
...
class Batch(object):
    ...
    heatmaps : None or list of imgaugv1.augmentables.heatmaps.HeatmapsOnImage
        The heatmaps to augment.

    segmentation_maps : None or list of imgaugv1.augmentables.segmaps.SegmentationMapsOnImage
        The segmentation maps to augment.

    keypoints : None or list of imgaugv1.augmentables.kps.KeypointOnImage
        The keypoints to augment.

    bounding_boxes : None or list of imgaugv1.augmentables.bbs.BoundingBoxesOnImage
        The bounding boxes to augment.

    polygons : None or list of imgaugv1.augmentables.polys.PolygonsOnImage
        The polygons to augment.

    line_strings : None or list of imgaugv1.augmentables.lines.LineStringsOnImage
        The line strings to augment.
    ...
    def deepcopy(self,
        ...
        Parameters
        ----------
        images_unaug : imgaugv1.augmentables.batches.DEFAULT or None or (N,H,W,C) ndarray or list of (H,W,C) ndarray
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        images_aug : imgaugv1.augmentables.batches.DEFAULT or None or (N,H,W,C) ndarray or list of (H,W,C) ndarray
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        heatmaps_unaug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.heatmaps.HeatmapsOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        heatmaps_aug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.heatmaps.HeatmapsOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        segmentation_maps_unaug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.segmaps.SegmentationMapsOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        segmentation_maps_aug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.segmaps.SegmentationMapsOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        keypoints_unaug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.kps.KeypointOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        keypoints_aug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.kps.KeypointOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        bounding_boxes_unaug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.bbs.BoundingBoxesOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        bounding_boxes_aug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.bbs.BoundingBoxesOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        polygons_unaug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.polys.PolygonsOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        polygons_aug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.polys.PolygonsOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        line_strings_unaug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.lines.LineStringsOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        line_strings_aug : imgaugv1.augmentables.batches.DEFAULT or None or list of imgaugv1.augmentables.lines.LineStringsOnImage
            Copies the current attribute value without changes if set to
            ``imgaugv1.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.
...
class _BatchInAugmentation(object):
    ...
    def invert_subselect_rows_by_indices_(self, indices, batch_subselected):
        ...
        --------
        >>> import numpy as np
        >>> from imgaugv1.augmentables.batches import _BatchInAugmentation
    ...
    def propagation_hooks_ctx(self, augmenter, hooks, parents):
        ...
        hooks : imgaugv1.imgaugv1.HooksImages or imgaugv1.imgaugv1.HooksKeypoints
    ...
    def to_batch(self, batch_before_aug):
        ...
        Parameters
        ----------
        batch_before_aug : imgaugv1.augmentables.batches.Batch
