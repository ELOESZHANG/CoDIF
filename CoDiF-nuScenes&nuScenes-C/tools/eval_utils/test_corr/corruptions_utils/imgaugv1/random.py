...
It provides the :class:`~imgaugv1.random.RNG` class, which is the primary
random number generator in ``imgaugv1``. It also provides various utility
...
generation classes and methods behin imgaugv1-specific classes and methods.
...
- *RandomState*: An instance of `numpy.random.RandomState`.
  ...
  :class:`numpy.random.Generator` or :class:`~imgaugv1.random.RNG`.
- *RNG*: An instance of :class:`~imgaugv1.random.RNG`.

Examples
--------

>>> import random as iarandom
...
class RNG(object):
    """
    Random number generator for imgaugv1.
    ...
    * :func:`numpy.random.RandomState.set_state`
    ...
    In :func:`~imgaugv1.random.RNG.choice`, the `axis` argument is not yet
    supported.
    ...
    def equals(self, other):
        ...
        assert isinstance(other, RNG), (
            ...
            "Use imgaugv1.random.is_generator_equal_to() to compare "
    ...
    def advance_(self):
        ...
        .. note::
            ...
            changes, call :func:`~imgaugv1.random.RNG.derive_rng_`.
    ...
    def duplicate(self, n):
        ...
        calls of :func:`~imgaugv1.random.RNG.derive_rngs_`. These calls
    ...
    def create_fully_random(cls):
        ...
        RNG
            ...
            RNG, nor does it depend on the seeding of imgaugv1 or numpy.
...
def seed(entropy):
    """Set the seed of imgaugv1's global RNG (in-place).
...
def set_generator_state_(generator, state):
    ...
    state : tuple or dict
        ...
        :func:`~imgaugv1.random.get_generator_state`.
...
def advance_generator_(generator):
    ...
    .. note::
        ...
        a call of this method will not completely change the outputs of
        the next called sampling method. To achieve more drastic output
        changes, call :func:`~imgaugv1.random.derive_generator_`.
