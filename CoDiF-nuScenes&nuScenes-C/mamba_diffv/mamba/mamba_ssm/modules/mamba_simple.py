...
class Block2(nn.Module):
    ...
    def forward(self, x):
        # Disable checkpointing during inference
        if self.training and self.with_cp:  # Only use checkpoint in training mode
            if self.post_norm:
        ...
        else:  # Inference mode or if checkpoint is disabled
            if self.post_norm:
