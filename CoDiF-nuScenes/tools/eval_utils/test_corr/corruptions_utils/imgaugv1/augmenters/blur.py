...
class GaussianBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See ``~imgaugv1.augmenters.blur.blur_gaussian_(backend="auto")``.
...
class AverageBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    k : int or tuple of int or tuple of tuple of int or imgaugv1.parameters.StochasticParameter or tuple of StochasticParameter, optional
        Kernel size to use.
...
class MedianBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    k : int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter, optional
        Kernel size.
...
class BilateralBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    d : int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter, optional
    ...
    sigma_color : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
    ...
    sigma_space : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
...
class MotionBlur(iaa_convolutional.Convolve):
    ...
    **Supported dtypes**:
    ...
    See :class:`~imgaugv1.augmenters.convolutional.Convolve`.
    ...
    angle : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
    ...
    direction : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
...
class MeanShiftBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.augmenters.blur.blur_mean_shift_`.

    Parameters
    ----------
    spatial_radius : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
        Spatial radius for pixels that are assumed to be similar.
    ...
    color_radius : number or tuple of number or list of number or imgaugv1.parameters.StochasticParameter, optional
        Color radius for pixels that are assumed to be similar.
