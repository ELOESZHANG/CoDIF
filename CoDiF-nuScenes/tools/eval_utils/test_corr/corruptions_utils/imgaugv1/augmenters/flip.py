...
def fliplr(arr):
    ...
    **Supported dtypes**:
    ...
    --------
    >>> import numpy as np
    >>> import imgaugv1.augmenters.flip as flip
...
def _fliplr_cv2(arr):
    ...
    if arr.ndim == 3 and arr.shape[-1] > 512:
        ...
        # Normalization from imgaugv1.imgaugv1._normalize_cv2_input_arr_().
...
class Fliplr(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.augmenters.flip.fliplr`.

    Parameters
    ----------
    p : number or imgaugv1.parameters.StochasticParameter, optional
...
class Flipud(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.augmenters.flip.flipud`.
