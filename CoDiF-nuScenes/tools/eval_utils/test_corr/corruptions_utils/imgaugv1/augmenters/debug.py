...
def draw_debug_image(images, heatmaps=None, segmentation_maps=None,
    ...
    **Supported dtypes**:
    ...
    heatmaps : None or list of imgaugv1.augmentables.heatmaps.HeatmapsOnImage, optional
        Heatmaps on the provided images.

    segmentation_maps : None or list of imgaugv1.augmentables.segmaps.SegmentationMapsOnImage, optional
        Segmentation maps on the provided images.

    keypoints : None or list of imgaugv1.augmentables.kps.KeypointsOnImage, optional
        Keypoints on the provided images.

    bounding_boxes : None or list of imgaugv1.augmentables.bbs.BoundingBoxesOnImage, optional
        Bounding boxes on the provided images.

    polygons : None or list of imgaugv1.augmentables.polys.PolygonsOnImage, optional
        Polygons on the provided images.

    line_strings : None or list of imgaugv1.augmentables.lines.LineStringsOnImage, optional
    ...
    >>> from imgaugv1.augmentables.batches import UnnormalizedBatch
    ...
    ``UnnormalizedBatch`` to show how to mostly evade going through imgaugv1
    classes.
...
class SaveDebugImageEveryNBatches(_SaveDebugImage):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.augmenters.debug.draw_debug_image`.
