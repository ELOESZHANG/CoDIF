...
class AveragePooling(_AbstractPoolingBase):
    ...
    *without* striding, while ``AveragePooling`` applies striding corresponding
    ...
    .. note::
        ...
        are updated. This is because imgaugv1 can handle maps/maks that are
        larger/smaller than their corresponding image.

    **Supported dtypes**:

    See :func:`~imgaugv1.imgaugv1.avg_pool`.

    Attributes
    ----------
    kernel_size : int or tuple of int or list of int or imgaugv1.parameters.StochasticParameter or tuple of tuple of int or tuple of list of int or tuple of imgaugv1.parameters.StochasticParameter, optional
...
class MaxPooling(_AbstractPoolingBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.imgaugv1.max_pool`.
...
class MinPooling(_AbstractPoolingBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.imgaugv1.min_pool`.
...
class MedianPooling(_AbstractPoolingBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~imgaugv1.imgaugv1.median_pool`.
