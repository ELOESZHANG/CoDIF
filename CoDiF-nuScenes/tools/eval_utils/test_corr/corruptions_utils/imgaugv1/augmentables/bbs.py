...
class BoundingBox(object):
    ...
    def intersection(self, other, default=None):
        ...
        Parameters
        ----------
        other : imgaugv1.augmentables.bbs.BoundingBox
        ...
        Returns
        -------
        imgaugv1.augmentables.bbs.BoundingBox or any
    ...
    def draw_on_image(self, image, color=(0, 255, 0), alpha=1.0, size=1,
        ...
        :func:`~imgaugv1.augmentables.bbs.BoundingBox.draw_box_on_image`.
        To draw the label even if it is ``None`` or to configure e.g. its
        color, use
        :func:`~imgaugv1.augmentables.bbs.BoundingBox.draw_label_on_image`.
    ...
    def coords_almost_equals(self, other, max_distance=1e-4):
        ...
        Parameters
        ----------
        other : imgaugv1.augmentables.bbs.BoundingBox or iterable
    ...
    def almost_equals(self, other, max_distance=1e-4):
        ...
        This is the same as
        :func:`~imgaugv1.augmentables.bbs.BoundingBox.coords_almost_equals` but
        ...
        max_distance : number, optional
            See
            :func:`~imgaugv1.augmentables.bbs.BoundingBox.coords_almost_equals`.
    ...
    def from_point_soup(cls, xy):
        ...
        :func:`~imgaugv1.BoundingBoxesOnImage.to_xyxy_array`.
...
class BoundingBoxesOnImage(IAugmentable):
    ...
    Parameters
    ----------
    bounding_boxes : list of imgaugv1.augmentables.bbs.BoundingBox
    ...
    --------
    >>> import numpy as np
    >>> from imgaugv1.augmentables.bbs import BoundingBox, BoundingBoxesOnImage
    >>>
    ...
    def on_(self, image):
        ...
        Returns
        -------
        imgaugv1.augmentables.bbs.BoundingBoxesOnImage
    ...
    def to_xyxy_array(self, dtype=np.float32):
        ...
        This is the inverse of
        :func:`~imgaugv1.BoundingBoxesOnImage.from_xyxy_array`.
    ...
    def fill_from_xy_array_(self, xy):
        ...
        See
        :func:`~imgaugv1.augmentables.bbs.BoundingBoxesOnImage.fill_from_xyxy_array_`.
    ...
    def copy(self, bounding_boxes=None, shape=None):
        ...
        Parameters
        ----------
        bounding_boxes : None or list of imgaugv1.augmntables.bbs.BoundingBox, optional
            List of bounding boxes on the image.
    ...
    def __getitem__(self, indices):
        ...
        Returns
        -------
        list of imgaugv1.augmentables.bbs.BoundingBoxes
