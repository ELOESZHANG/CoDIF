...
def _quokka_normalize_extract(extract):
    ...
    Added in 0.5.0. (Moved from ``imgaugv1.imgaugv1``.)

    Parameters
    ----------
    extract : 'square' or tuple of number or imgaugv1.augmentables.bbs.BoundingBox or imgaugv1.augmentables.bbs.BoundingBoxesOnImage
        Unnormalized representation of the image subarea to be extracted.
            ...
            * If a :class:`~imgaugv1.augmentables.bbs.BoundingBox`, then that
              bounding box's area will be extracted from the image.
            * If a :class:`~imgaugv1.augmentables.bbs.BoundingBoxesOnImage`,
    ...
    from augmentables.bbs import BoundingBox, BoundingBoxesOnImage
...
def quokka(size=None, extract=None):
    ...
    size : None or float or tuple of int, optional
        ...
        :func:`~imgaugv1.imgaugv1.imresize_single_image`. Usually expected to be a
        ``tuple`` ``(H, W)``, where ``H`` is the desired height and ``W`` is
        the width. If ``None``, then the image will not be resized.

    extract : None or 'square' or tuple of number or imgaugv1.augmentables.bbs.BoundingBox or imgaugv1.augmentables.bbs.BoundingBoxesOnImage
...
def quokka_heatmap(size=None, extract=None):
    ...
    ----------
    size : None or float or tuple of int, optional
        See :func:`~imgaugv1.imgaugv1.quokka`.
    ...
    # TODO get rid of this deferred import
    from . import imgaug as ia
    from augmentables.heatmaps import HeatmapsOnImage
...
def quokka_segmentation_map(size=None, extract=None):
    ...
    import skimage.draw
    # TODO get rid of this deferred import
    from augmentables.segmaps import SegmentationMapsOnImage
...
def quokka_keypoints(size=None, extract=None):
    ...
    extract : None or 'square' or tuple of number or imgaugv1.augmentables.bbs.BoundingBox or imgaugv1.augmentables.bbs.BoundingBoxesOnImage
        Subarea to extract from the image. See :func:`~imgaugv1.imgaugv1.quokka`.
    ...
    """
    # TODO get rid of this deferred import
    from augmentables.kps import Keypoint, KeypointsOnImage
...
def quokka_polygons(size=None, extract=None):
    ...
    """
    # TODO get rid of this deferred import
    from augmentables.polys import Polygon, PolygonsOnImage
