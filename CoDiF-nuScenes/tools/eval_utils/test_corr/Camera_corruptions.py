...
from .corruptions_utils.imgaugv1 import augmenters as iaa
...
from .corruptions_utils.weather import Automold as am
...
def points_cam2img(points_3d, proj_mat, with_depth=False):
    ...
    point_2d = torch.matmul(points_4.to(torch.float32), proj_mat.t().to(torch.float32))
...
class ImagePointAddSun():
    ...
    def __call__(self, image, points, lidar2img, watch_img=False, file_path='') -> np.array:
        ...
        # except:
        #     print('sunlight Lidar err: TODO: dxg ')
