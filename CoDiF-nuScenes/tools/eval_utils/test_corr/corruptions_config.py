...
class Corruptions_mode(metaclass=Singleton):
    def __init__(self) -> None:
        ...
        #### snow
        self.corruption_type_l = 'crosstalk'  # ['None' ,'rain','fog',    'None','density','cutout','crosstalk','gaussian','uniform','impulse',]
        self.corruption_type_c = 'None' # ['snow' ,'rain','fog','sunlight_f','None',   'None',  'None',     'gaussian','uniform','impulse',]
        self.severity = 1  #0,1-5
