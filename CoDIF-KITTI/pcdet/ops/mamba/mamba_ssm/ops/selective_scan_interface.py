...
class MambaInner_ursus(torch.autograd.Function):
...
def mamba_inner_ursus(
        xz, conv1d_weight, conv1d_bias, x_proj_weight, delta_proj_weight, BC_proj_weight,
        A, B=None, C=None, D=None, delta_bias=None, B_proj_bias=None,
        C_proj_bias=None, delta_softplus=True,
        interaction_mode='cosine', topk_ratio=0.5  # 新增参数
):
    return MambaInner_ursus.apply(
        xz, conv1d_weight, conv1d_bias, x_proj_weight, delta_proj_weight,BC_proj_weight,
        A, B, C, D, delta_bias, B_proj_bias, C_proj_bias, delta_softplus,
