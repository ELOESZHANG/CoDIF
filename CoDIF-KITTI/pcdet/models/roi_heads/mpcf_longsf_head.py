...
from .mpcf_longsf_part import Baseline_color, ColorEh, Fusion3


class MPCFHead_longsf(RoIHeadTemplate):
    def __init__(self, input_channels, model_cfg, point_cloud_range, voxel_size, num_class=1, **kwargs):
        ...
        self.fusion_layer = Fusion3(c_out, channel2, self.model_cfg.ATTENTION_FC[0],self.model_cfg.Mamba_CFG)
    ...
    def forward(self, batch_dict):
        ...
        fusion_features = self.fusion_layer(x_valid, x_pseudo,frame_idss)
