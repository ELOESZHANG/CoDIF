...
from pcdet.models.roi_heads.model_util.REmbedding_util import VisionRotaryEmbeddingFast, get_2d_sincos_pos_embed, RMSNorm
...
def s_16_2(**kwargs):
    return JiT(depth=2, hidden_size=384, num_heads=6,
               bottleneck_dim=128, in_context_len=32, in_context_start=1, patch_size=16, **kwargs)

def s_16_4(**kwargs):
    return JiT(depth=4, hidden_size=768, num_heads=8,
               bottleneck_dim=128, in_context_len=32, in_context_start=2, patch_size=16, **kwargs)
