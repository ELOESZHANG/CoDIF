...
from .mpcf_part import Fusion3, Baseline_color, ColorEh


class MPCFHead(RoIHeadTemplate):
    def __init__(self, input_channels, model_cfg, point_cloud_range, voxel_size, num_class=1, **kwargs):
        ...
        self.fusion_layer = Fusion3(c_out, channel2, self.model_cfg.ATTENTION_FC[0])
        ...
        if self.training:
            ...
            pre_channel_pseudo = GRID_SIZE * GRID_SIZE * GRID_SIZE * channel2
    ...
    def forward(self, batch_dict):
        ...
        points_features_expand = self.colorbase_layer1(points_features, points_neighbor)
        ...
        #     rb = 0.25
        # else:
        #     rb = 0.25 #0.1-90.41 0.2-90.477  0.25-90.49 0.05-90.36
